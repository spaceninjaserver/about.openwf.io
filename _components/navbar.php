		...
		<div class="collapse navbar-collapse" id="navbar-content">
			<ul class="navbar-nav me-auto mb-0">
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle<?=(($path == "/client-setup" || $path == "/web-server-setup" || $path == "/import" || $path == "/chat-server-setup" || $path == "/hub-server-setup" || $path == "/nrs-setup" || $path == "/port-forwarding" || $path == "/dockerized-server-setup" || $path == "/hardening-security" || $path == "/metadata-patching" || $path == "/lean-and-mean" || $path == "/asset-replacements-guide") ? " active" : ""); ?>" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Guides</a>
					<ul class="dropdown-menu">
						...
						<li><a class="dropdown-item<?=($path == "/lean-and-mean" ? " active" : ""); ?>" href="lean-and-mean<?=$ext;?>">Trimming Installs</a></li>
