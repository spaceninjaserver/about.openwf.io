		...
		<table class="table table-sm">
			...
			<tbody>
				...
				<tr>
					...
					<td>≈ 22.0.0</td>
					<td>Plains of Eidolon</td>
					<!-- Need to go through tutorial v2 -->
				</tr>
				<tr>
					...
					<!-- Need to go through tutorial v2, has some horrible stutters -->
				</tr>
				...
				<tr>
					...
					<td>≈ 21.0.0</td>
					<td>Chains of Harrow</td>
					<!-- Need to go through tutorial v2 but can skip its cutscenes -->
				</tr>
				...
				<!-- <tr>
					...
					Needs some work still, the HTTP request stuff here is a bit different.
				</tr> -->
			</tbody>
		</table>
