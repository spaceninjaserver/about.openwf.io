...
<body data-bs-theme="dark">
	...
	<div class="container mt-3">
		<p>This guide will explain the process of setting up the Bootstrapper in a Warframe install, which will allow you to connect to custom servers. <a href="client-setup-manual<?=$ext;?>">Manual version here.</a></p>
		<!-- <h2>Prerequisites</h2>
		...
		<h2>Setup</h2>
		<ol>
			<li><a href="supplementals/Bootstrapper Setup.exe" target="_blank">Download Bootstrapper Setup</a> (<a href="https://onlyg.it/OpenWF/Bootstrapper-Setup" target="_blank">source code</a>, <a href="https://openwf.io/supplementals/Bootstrapper%20Setup.sh" download>Linux version</a>)</li>
