...
<body data-bs-theme="dark">
	...
	<div class="container mt-3">
		...
		<div id="download-view" class="d-none">
			<h3>Downloading <span id="version-name"></span></h3>
			...
			<p class="dv-cond dv-cond-cafee">To download this version of Warframe, you only need BitTorrent v1 compatible software: <a class="torrent" download>Torrent</a>, <a class="magnet">Magnet</a></p>
	...
	<script>
		...
		window.onhashchange = function()
		{
			...
			if (tr)
			{
				...
				{
					// Manifest
					document.getElementById("version-name").textContent = "M:" + hash;
