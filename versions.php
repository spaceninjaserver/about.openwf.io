				...
				<div class="accordion-item">
					...
					<div id="collapse-mango" class="accordion-collapse collapse show" data-bs-parent="#depot-download-accordion">
						<div class="accordion-body">
							<ol>
								<li><a href="https://github.com/Sainan/steam-manifest-tools/releases" target="_blank">Download mango</a> and extract it</li>
								<li>Open a command prompt in the folder where you have mango.exe</li>
								<li>Run <code>mango download-and-install 230411 <span class="manifest-id"></span></code></li>
							</ol>
