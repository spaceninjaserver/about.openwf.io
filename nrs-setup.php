...
<body data-bs-theme="dark">
	...
	<div class="container mt-3">
		...
		<h3>e-nrs</h3>
		<p>This instance supports 7.3.0 - 42.0.11 and <abbr title="Proxying allows people behind strict NAT to establish indirect connections to each other.">proxying</abbr>. You can configure SpaceNinjaServer to instruct your clients to connect to it like so:</p>
		<ul>
